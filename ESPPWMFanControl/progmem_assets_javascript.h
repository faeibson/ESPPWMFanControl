...
#ifndef _PROGMEM_ASSETS_JAVASCRIPT_H_
#define _PROGMEM_ASSETS_JAVASCRIPT_H_

namespace progmem_assets_javascript {
    ...
    static const char main[] PROGMEM = R"==(
        ...
        var fanControlSetRowTemplate = '<li data-row-number="{{rowNumber}}" id="fanControlSetRow{{rowNumber}}"><span id="fanControlSetRowText{{rowNumber}}">{{rowText}}</span><input type="text" size="3" placeholder="{{placeholderFan1}}" name="{{nameFan1}}" id="{{idFan1}}" value="{{valueFan1}}" />% <input type="text" size="3" placeholder="{{placeholderFan2}}" name="{{nameFan2}}" id="{{idFan2}}" value="{{valueFan2}}" />% <input type="text" size="3" placeholder="{{placeholderFan3}}" name="{{nameFan3}}" id="{{idFan3}}" value="{{valueFan3}}" />% above <input type="text" size="3" placeholder="{{placeholderTemp}}" name="{{nameTemp}}" id="{{idTemp}}" value="{{valueTemp}}" /> &deg;C <input type="button" onclick="removeFanControlSetRow(this.parentNode);" title="Remove row" class="link bold" value="&times;"/></li>';
